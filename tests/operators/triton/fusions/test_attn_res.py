...
from aiter.tuning.search.workloads.fusions.attn_res import (
...
__all__ = [
    ...
    "run_torch",
    "run_torch_gate",
    "run_torch_per_token_quant",
    "test_attn_res",
    "test_attn_res_gate",
    "test_attn_res_gate_add_hidden2",
    "test_attn_res_gate_add_hidden2_requires_add_hidden",
    "test_attn_res_gate_close_block",
    "test_attn_res_gate_close_block_composes_with_add2_and_onorm",
    "test_attn_res_gate_matches_attn_res_fwd",
    "test_attn_res_gate_no_add_returns_prefix_unchanged",
    "test_attn_res_gate_out_quant",
    "test_attn_res_gate_out_quant_matches_unfused_quant",
    "test_attn_res_gate_out_quant_requires_output_rms_weight",
    "test_attn_res_gate_output_rms_eps_independent_of_eps",
    "test_attn_res_gate_output_rmsnorm",
    "test_attn_res_gate_output_rmsnorm_matches_unfused",
    "test_attn_res_packed_tensor_input",
    "test_attn_res_sequence_requires_d_multiple_of_16",
]
