...
AITER_ROOT = str(BUILD_CONTEXT.package.parent)
CONFIGS_DIR = str(BUILD_CONTEXT.resource("configs"))
...
TUNER_FAMILIES = {
    ...
    "a8w8_blockscale": {
        "script": "aiter/tuning/search/gemm/a8w8_blockscale.py",
    ...
    "gradlib_bf16": {
        "script": "aiter/tuning/search/gemm/hipblaslt_cli.py",
        "csv_pattern": "bf16_tuned_gemm",
        "exclude_patterns": ["batched"],
        "config_property": "AITER_CONFIG_GEMM_BF16_FILE",
    },
    "csrc_bf16": {
        "script": "aiter/tuning/search/gemm/a16w16.py",
        "csv_pattern": "bf16_tuned_gemm",
        "exclude_patterns": ["batched"],
        "config_property": "AITER_CONFIG_GEMM_BF16_FILE",
    },
    "gdn_k5_opt": {
        "script": "aiter/tuning/search/recurrent/gdn_k5.py",
