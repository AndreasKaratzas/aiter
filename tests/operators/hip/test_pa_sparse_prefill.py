...
Example CLI usage::
    ...
    PYTHONPATH=. python3 tests/operators/hip/test_pa_sparse_prefill.py
    PYTHONPATH=. python3 tests/operators/hip/test_pa_sparse_prefill.py --mode dense
    PYTHONPATH=. python3 tests/operators/hip/test_pa_sparse_prefill.py --backend opus \\
