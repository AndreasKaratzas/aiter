...
from operators.hip.tuned_op_bench_utils import append_tuned_op_bench_rows
...
def test_fmoe(
    ...
    if kernel_bench:
        ...
        aiter.ops.moe.dispatch.kernel_bench_callable = kernel_bench_callable
        try:
            out2_ck = fused_moe(
                input,
                w1_qt_aiter,
            ...
            aiter.ops.moe.dispatch.kernel_bench_callable = None
        kernel_us = {}
...
def test_output_buffer_contract():
    ...
    sort = aiter.ops.moe.dispatch._moe_sorting_impl
    ...
    for in_place in (True, False):
        try:
            if not in_place:
                aiter.ops.moe.dispatch._moe_sorting_impl = sort_without_output
            buf = fresh_buffer()
            ...
            aiter.ops.moe.dispatch._moe_sorting_impl = sort
