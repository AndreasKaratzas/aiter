...
Usage::
    ...
    python tests/operators/hip/drivers/fused_kv_norm_rope_group_quant.py
    python tests/operators/hip/drivers/fused_kv_norm_rope_group_quant.py -T 64 256 1024
    python tests/operators/hip/drivers/fused_kv_norm_rope_group_quant.py --D 192 --RD 64
    python tests/operators/hip/drivers/fused_kv_norm_rope_group_quant.py --neox
"""
