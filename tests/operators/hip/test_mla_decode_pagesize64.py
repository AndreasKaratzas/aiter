...
#   python3 tests/operators/hip/test_mla_decode_pagesize64.py -n 8,1
#
#   # Sweep all supported public dispatch cases:
#   python3 tests/operators/hip/test_mla_decode_pagesize64.py
#
#   # Peak-performance sweep from the gfx1250 MLA report:
#   python3 tests/operators/hip/test_mla_decode_pagesize64.py -n 8,1 8，2 16，1 32，1 -b 1024 -c 16384 --split_kv auto
...
import aiter
import aiter.ops.attention.mla
...
def _make_mla_mi400_case(
    *,
    ...
    prepare_native(targets=(get_gfx(),))
    ...
    if num_kv_splits is None:
        ...
        num_kv_splits, num_kv_splits_indptr = aiter.ops.attention.mla.get_meta_param(
            None,
            batch,
...
def test_mla(
    ...
    def run_mla_decode(out_tensor):
        return aiter.ops.attention.mla.mla_decode_fwd(
            q_mi400,
            kv_buffer_mi400,
            out_tensor,
            qo_indptr,
