...
`tests/operators/hip/drivers/quant.py` / `tests/operators/hip/test_batched_gemm_bf16.py`):
...
Usage:
  ...
  ENABLE_CK=0 python tests/operators/hip/test_mla_v4_kargpreld.py
"""
...
# kernels/gfx1250/mla_v4/mla_v4_asm.csv served by csrc/py_itfs_cu/asm_mla_v4.cu).
# ---------------------------------------------------------------------------
...
def _asm_attn_decode_bf16(
    ...
    `aiter.ops.attention.mla.mla_decode_fwd_v4_nm`, and reduce/reshape the FP32 split logits
