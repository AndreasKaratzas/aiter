...
Usage:
    python tests/operators/hip/test_gemm_codegen.py
    GPU_ARCHS=gfx942 python tests/operators/hip/test_gemm_codegen.py
"""
...
def test_write_name_keyed_lookup_header():
    ...
    from aiter.jit.utils.chip_info import write_name_keyed_lookup_header
...
def test_write_lookup_header():
    ...
    from aiter.jit.utils.chip_info import write_lookup_header
...
def test_build_tune_dict_strict_unknown_kernel():
    ...
    from aiter.jit.utils.chip_info import build_tune_dict, build_tune_dict_batched
