...
Follows tests/operators/hip/drivers/quant.py layout (aiter-op-test SKILL).

Examples:
  python tests/operators/hip/test_mla_ltx.py
    # default on gfx950: PR global-load .co sweep (8 presets, ps, boundary+page16m)
  python tests/operators/hip/test_mla_ltx.py --preset qh64_fp8_q1 --ps ps --lse off --page-base 19000000 --ctx 4
  python tests/operators/hip/test_mla_ltx.py --preset qh16_fp8_q1 qh64_bf16_q1 --suites boundary --ps ps --lse off
  python tests/operators/hip/test_mla_ltx.py --suites page16m -d fp8 -kvd fp8 -n 16,1 --ps ps --lse off --ctx 4
  MLA_PAGE_OOB_NUM_PAGES=3800000 python tests/operators/hip/test_mla_ltx.py --suites over4g
"""
...
# Decode absorb rows from kernels/gfx950/mla/mla_asm.csv (prefill=0, causal=1, cprr=0).
