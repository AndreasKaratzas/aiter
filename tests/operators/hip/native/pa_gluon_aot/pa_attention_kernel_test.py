...
from operators.triton.test_pa_decode_gluon import (
    create_kv_cache,
...
from aiter.testing import perftest
...
def compile_attention_kernel(
    ...
    if compile_reduce_kernel_count == 1:
        ...
        with open(
            f"{AITER_NATIVE_DIR}/cpp_itfs/pa_gluon_aot/pa_decode_attention_kernel.cpp.jinja",
            "r",
        ) as f:
