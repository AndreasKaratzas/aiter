...
CI runs this via ``python3 tests/operators/hip/test_mla_decode_gate.py`` (also
pytest-collectable).
"""
...
from aiter.ops.attention.mla import _persistent_mla_decode_max_batch, _use_persistent_mla_decode
