...
Usage:
    python tests/operators/hip/test_fused_qk_norm_rope_group_quant.py
    python tests/operators/hip/test_fused_qk_norm_rope_group_quant.py -T 64 256 1024 --H 16 128
    python tests/operators/hip/test_fused_qk_norm_rope_group_quant.py --no-flydsl   # skip the perf compare
"""
