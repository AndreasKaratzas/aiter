...
Style mirrors tests/operators/hip/drivers/pa_ps.py: a torch host reference is compared against
the kernel via aiter.testing.checkAllclose (no pytest), driven by argparse
...
from aiter.testing import benchmark, checkAllclose, perftest
