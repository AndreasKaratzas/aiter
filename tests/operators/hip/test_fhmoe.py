...
def test_heterogeneous_moe_uses_a_separate_custom_op_schema():
    from aiter.ops.moe.flydsl import fhmoe_
...
def _mock_dsv4_i384_fhmoe_metadata(monkeypatch: pytest.MonkeyPatch):
    ...
    fused_moe_module = importlib.import_module("aiter.ops.moe.dispatch")
...
def test_dsv4_i384_fhmoe_config_scope(
    ...
    from aiter.ops.moe.flydsl import _uses_dsv4_fhmoe_config
...
def test_dsv4_i384_fhmoe_capability(
    ...
    from aiter.ops.moe.flydsl import supports_dsv4_i384_fhmoe
...
def test_dsv4_i384_fhmoe_capability_follows_csv(
    ...
    fhmoe = importlib.import_module("aiter.ops.moe.flydsl")
    _mock_dsv4_i384_fhmoe_metadata(monkeypatch)
    config_path = BuildContext.load().resource("configs", "tuned_fhmoe.csv")
...
def test_dsv4_i384_fhmoe_config_requires_exact_bucket(
    ...
    fused_moe_module = importlib.import_module("aiter.ops.moe.dispatch")
    source_path = BuildContext.load().resource("configs", "tuned_fhmoe.csv")
...
def test_dsv4_i384_fhmoe_config_has_true_shapes():
    ...
    config_path = BuildContext.load().resource("configs", "tuned_fhmoe.csv")
    ordinary_path = BuildContext.load().resource(
        "configs", "model_configs/dsv4_fp8fp4_tuned_fmoe.csv"
    )
