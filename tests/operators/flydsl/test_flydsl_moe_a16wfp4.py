...
``tests/operators/hip/drivers/moe_2stage.py``. It goes through ``fused_moe`` (or
``flydsl_a16w4_gemm1/2``), NOT the removed low-level ``compile_mixed_moe_gemm1_a16w4``
API.

Run:
    pytest tests/operators/flydsl/test_flydsl_moe_a16wfp4.py -q
"""
...
from aiter.ops.moe.dispatch import fused_moe, fused_topk, torch_moe_stage1, torch_moe_stage2
