...
Usage:
    pytest tests/operators/flydsl/test_flydsl_moe_a8w4.py -q
    pytest tests/operators/flydsl/test_flydsl_moe_a8w4.py -k tile_k
"""
...
from aiter.ops.moe.dispatch import fused_topk, moe_sorting, torch_moe_stage1, torch_moe_stage2
...
def test_situv2_reference():
    """Verify aiter.ops.moe.dispatch.situv2 matches the closed-form SiTUv2 in fp32.

    Host-only (no GPU / gfx950 required)."""
    from aiter.ops.moe.dispatch import situv2
