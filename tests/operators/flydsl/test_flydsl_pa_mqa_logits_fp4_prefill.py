...
Usage:
    python tests/operators/flydsl/test_flydsl_pa_mqa_logits_fp4_prefill.py
    python tests/operators/flydsl/test_flydsl_pa_mqa_logits_fp4_prefill.py --bench --bs 4 --ctx 2048 --n_q 64
"""
