...
Usage:
    python tests/operators/flydsl/test_flydsl_qk_norm_rope_quant.py
    python tests/operators/flydsl/test_flydsl_qk_norm_rope_quant.py -T 64 256 1024 -q fp8_1x128_e8m0
    python tests/operators/flydsl/test_flydsl_qk_norm_rope_quant.py --no-quant   # bf16 only
"""
