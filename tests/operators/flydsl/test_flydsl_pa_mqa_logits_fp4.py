...
Usage:
    python tests/operators/flydsl/test_flydsl_pa_mqa_logits_fp4.py
    python tests/operators/flydsl/test_flydsl_pa_mqa_logits_fp4.py --batch 8 --ctx 131072 --next_n 1
"""
