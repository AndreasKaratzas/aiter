...
Usage:
    python3 tests/operators/opus/test_opus_a16w16_gemm.py [-m M -n N -k K -b B]
    python3 tests/operators/opus/test_opus_a16w16_gemm.py --csv_file <shape_csv>

    # opus-only sweep in CUDA-graph mode, golden-checked (default entry):
    python3 tests/operators/opus/test_opus_a16w16_gemm.py --opus_sweep -n 2048 -k 7168
"""
...
if not _arch_ok:
    ...
    if __name__ != "__main__":
        ...
        pytest.skip(
            "operator prerequisites are unavailable on this target",
...
if __name__ == "__main__":
    ...
    # `python3 tests/operators/opus/test_opus_a16w16_gemm.py` reproduces the table.
