...
``aiter/tuning/search/gemm/opus_bmm_mxscale.py``.
...
Usage:
    python3 tests/operators/opus/test_opus_a8w8_bmm.py
    python3 tests/operators/opus/test_opus_a8w8_bmm.py -s 512,1024,4096 -g 2 -d bf16
    python3 tests/operators/opus/test_opus_a8w8_bmm.py --check-m-align
"""
...
def test_mxscale_bmm(g, m, n, k, dtype):
    ...
    # aiter/tuning/search/gemm/opus_bmm_mxscale.py, not here.
...
def test_mxscale_bmm_batch_first(g, m, n, k, dtype):
    ...
    # out=. Per-kid perf sweep lives in aiter/tuning/search/gemm/opus_bmm_mxscale.py.
...
__all__ = [
    ...
    "_quant_per_token_e8m0",
    "check_m_align",
    "check_tilen_column_map",
    "main",
    "run_torch",
    "test_mxscale_bmm",
    "test_mxscale_bmm_batch_first",
]
