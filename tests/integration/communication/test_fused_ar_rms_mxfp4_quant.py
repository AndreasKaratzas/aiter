...
Examples:
    ...
    python tests/integration/communication/test_fused_ar_rms_mxfp4_quant.py

    # CI smoke at a single TP (debug):
    python tests/integration/communication/test_fused_ar_rms_mxfp4_quant.py -t 8

    # Local dense sweep, all TPs:
    python tests/integration/communication/test_fused_ar_rms_mxfp4_quant.py --full
