...
Run:
    pytest tests/integration/communication/test_reuse_identical_rank_groups.py
    python  tests/integration/communication/test_reuse_identical_rank_groups.py  # no pytest
"""
