...
# cktile
from aiter.codegen.gemm.ck_a8w8_blockscale.ck_tile_instances import (
    BLOCK_PER_CU_MAX,
    candidate_kernels_cktile_dict,
)
from aiter.codegen.gemm.ck_a8w8_blockscale.instances import candidate_kernels_dict
from aiter.codegen.gemm.ck_a8w8_blockscale_bpreshuffle.instances import (
    kernels_list as candidate_kernels_bpreshuffle_dict,
)
from aiter.codegen.gemm.opus.instances import gfx942_a8w8_kernels_list
