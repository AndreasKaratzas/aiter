...
This is intentionally smaller than ``aiter/codegen/gemm/opus/generate.py`` today:
...
// Copyright (C) 2026, Advanced Micro Devices, Inc. All rights reserved.
//
// Auto-generated. Do not edit. See aiter/codegen/moe/opus/generate.py.
//
...
// aiter/codegen/moe/opus/instances.py.
...
def main(argv=None, *, context=None):
    ...
    parser.add_argument("--working_path", "--output", required=True)
