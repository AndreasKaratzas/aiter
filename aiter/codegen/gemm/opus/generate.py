...
from aiter.codegen.gemm.opus.architectures import (
    gen_instances_gfx942 as _gfx942,  # noqa: F401
)

# Import for side-effect: each arch module self-registers into EMIT_REGISTRY
# and ARCH_MAP_REGISTRY at import time.
from aiter.codegen.gemm.opus.architectures import (
    gen_instances_gfx950 as _gfx950,  # noqa: F401
)
from aiter.codegen.gemm.opus.architectures import (
    gen_instances_gfx1250 as _gfx1250,  # noqa: F401
)
from aiter.codegen.gemm.opus.architectures.common import (
    _A16W16_CO_TAGS,
    _A16W16_TAGS,
    _GFX942_A16W16_TAGS,
    _NOSPLIT,
...
def _pipeline_header_for(k):
    if getattr(k, "is_4g_safe", False):
        ...
        from aiter.codegen.gemm.opus.architectures.gen_instances_gfx950 import (
...
class opus_gemm_codegen:
    ...
    def gen_instance(self, k: OpusGemmInstance):
        from aiter.codegen.gemm.opus.architectures.gen_instances_gfx942 import (
        ...
        from aiter.codegen.gemm.opus.architectures.common import dispatch_emit
...
def main(argv=None, *, context=None):
    ...
    assert not missing_heuristic, (
        ...
        f"in aiter/codegen/gemm/opus/instances.py."
    )
