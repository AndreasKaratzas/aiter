...
from aiter.codegen.gemm.ck_batched_bf16.instances import (
    default_kernels_dict,
    kernelInstance,
    kernels_list,
)
from aiter.jit.utils.chip_info import build_tune_dict_batched, write_lookup_header
...
def main(argv=None, *, context=None):
    ...
    parser.add_argument(
        ...
        "--tune_file",
        "--tune-file",
        default=str(context.resource("configs", "bf16_tuned_batched_gemm.csv")),
        required=False,
