...
def _use_fhmoe_wrappers(metadata):
    ...
    from aiter.ops.moe.dispatch import _flydsl_stage1_wrapper, _flydsl_stage2_wrapper
...
def _supports_dsv4_i384_fhmoe_config(max_tokens: int, config_file: str) -> bool:
    try:
        from aiter.ops.moe.dispatch import get_2stage_cfgs, get_padded_M
...
def fhmoe_(
    ...
    from aiter.ops.moe.dispatch import _fused_moe_impl
