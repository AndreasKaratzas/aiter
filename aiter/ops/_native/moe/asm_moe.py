...
MD_NAME = "asm_moe"
with open(f"{AITER_NATIVE_DIR}/cpp_itfs/moe/asm_moe.cpp.jinja", "r") as f:
...
def compile(
    ...
    if not_built(folder):
        ...
        bin_size, bin_data = transfer_hsaco(f"{AITER_ASSEMBLY_DIR}/{co_name}")
...
def asm_moe(
    ...
    from aiter.ops._native.torch_utils import torch_to_c_types, torch_to_hip_types
