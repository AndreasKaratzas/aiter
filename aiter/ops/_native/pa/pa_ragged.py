...
from aiter.aot.compiler import AITER_NATIVE_DIR, compile_template_op, str_to_bool

MD_NAME = "pa_ragged"

with open(f"{AITER_NATIVE_DIR}/cpp_itfs/pa/pa_ragged.cpp.jinja", "r") as f:
...
def compile(
    ...
    return compile_template_op(
        ...
        MD_NAME,
        [
            f"{AITER_NATIVE_DIR}/cpp_itfs/utils.h",
            f"{AITER_NATIVE_DIR}/cpp_itfs/pa/pa_ragged.cuh",
            f"{AITER_NATIVE_DIR}/cpp_itfs/pa/pa_kernels.cuh",
            f"{AITER_NATIVE_DIR}/cpp_itfs/pa/pa_common.cuh",
            f"{AITER_NATIVE_DIR}/include",
            f"{AITER_NATIVE_DIR}/include/ck_tile/",
        ],
        gqa_ratio=gqa_ratio,
        head_size=head_size,
