...
from aiter.aot.compiler import AITER_NATIVE_DIR, compile_template_op

MD_NAME = "pa"

with open(f"{AITER_NATIVE_DIR}/cpp_itfs/pa/pa.cpp.jinja", "r") as f:
...
def compile(
    ...
    return compile_template_op(
        ...
        [
            ...
            f"{AITER_NATIVE_DIR}/cpp_itfs/pa/pa.cuh",
