...
from aiter.ops._native.sampling.util import get_seed_and_offset

MD_NAME = "top_k_top_p_sampling_from_probs"

with open(
    f"{AITER_NATIVE_DIR}/cpp_itfs/sampling/top_k_top_p_sampling_from_probs.cpp.jinja",
    "r",
) as f:
...
def compile(
    ...
    return compile_template_op(
        ...
        [
            ...
            f"{AITER_NATIVE_DIR}/cpp_itfs/sampling/sampling.cuh",
            f"{AITER_NATIVE_DIR}/cpp_itfs/sampling/vec_dtypes.cuh",
        ],
        vec_size=vec_size,
