...
```bash
GPU_ARCHS=gfx950 python tests/operators/opus/test_opus_a16w16_gemm.py -m 128 -n 256 -k 1024 -b 1
# CSV sweep (optional, if you have a shapes file):
GPU_ARCHS=gfx950 python tests/operators/opus/test_opus_a16w16_gemm.py --csv /path/to/shapes.csv
```
