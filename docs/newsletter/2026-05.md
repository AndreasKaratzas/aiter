# Historical newsletter — May 2026

> **Historical record, not current guidance.** This earlier newsletter is preserved as written below. Its release, hardware, roadmap and validation claims have not been independently re-established by the local redesign. Do not use its installation command or support statements to choose a current environment. Start with the [current installation guide](../installation.rst) and [current evidence](../../notes.md).
