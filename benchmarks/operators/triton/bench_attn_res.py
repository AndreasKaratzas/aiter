...
Usage (from the repository root):
  python -m benchmarks.operators.triton.bench_attn_res
  python -m benchmarks.operators.triton.bench_attn_res --layout packed
  python -m benchmarks.operators.triton.bench_attn_res -N 8192 -D 7168 -L 8
  python -m benchmarks.operators.triton.bench_attn_res --metric bandwidth --onorm
  python -m benchmarks.operators.triton.bench_attn_res --op gate --add-hidden
  python -m benchmarks.operators.triton.bench_attn_res --op gate --add-hidden2
  python -m benchmarks.operators.triton.bench_attn_res --op gate --close-block
  python -m benchmarks.operators.triton.bench_attn_res --op gate --sweep decode
...
from benchmarks.common.triton import (
