...
Usage:
  python -m benchmarks.operators.triton.bench_sparse_attention_dsv4_bwd
  python -m benchmarks.operators.triton.bench_sparse_attention_dsv4_bwd --breakdown
  python -m benchmarks.operators.triton.bench_sparse_attention_dsv4_bwd --cfgs 4096,128,512
"""
...
from aiter.testing.attention import sparse_mla_dsv4_ref
